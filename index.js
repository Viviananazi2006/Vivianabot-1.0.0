...
case "hola" :
enviartexto("hola soldado")
break

// case "imagen" :
// const imageso = fs.readFileSync("aquí la ruta de la imagen")
// enviarimagen(imageso)
// break

// case "imagen con captura"
// const imageso = fs.readFileSync("aquí la ruta de la imagen")
// const texto = "aquí el texto"
// enviarimagencap(imageso , texto)
// break

// case "video" :
// const videoso = fs.readFileSync("aquí la ruta del vídeo")
// enviarvideo(videoso)
// break

// case "video con captura"
// const videoso = fs.readFileSync("aquí la ruta del vídeo")
// const texto = "aquí el texto"
// enviarvideocap(videoso , texto)
// break

// case "audio" :
// const audioso = fs.readFileSync("aquí la ruta del audio")
// enviarimagen(audioso)
// break

// case "sticker" :
// const stickerso = fs.readFileSync("aquí la ruta del sticker")
// enviarsticker(stickerso)
// break

// case "documentos" :
// const documentoso = fs.readFileSync("aquí la ruta del documento")
// enviarimagen(documentoso)
// break

// case 'encuesta': {
// let menutxt = `prueba nazi bot`
// vm.sendPoll(from, menutxt, [`prueba3`,'nazi','bot'])
// }
// break
...
{interactiveMessage: {
body: { text: `viviana bot`,
},nativeFlowMessage: {
buttons: [{

                  "name": "cta_copy",
                  "buttonParamsJson": "{\"display_text\":\"copia\",\"id\":\"viviana pineda\",\"copy_code\":\"mano derecha\"}"
               }
...
buttons: [{
                  "name": "cta_url",
                  "buttonParamsJson": "{\"display_text\":\"urlsato\",\"url\":\"https://www.facebook.com/profile.php?id=100088330814766\",\"merchant_url\":\"https://www.facebook.com/profile.php?id=100088330814766\"}"
               }
            ],
            messageParamsJson: "",
          },
...
display_text: "comando 1",
id: `play`
}),},
{
name: "quick_reply",
buttonParamsJson: JSON.stringify({
display_text: "comando 2",
id: `toimg`
}),}, 
            ],
            messageParamsJson: "",
