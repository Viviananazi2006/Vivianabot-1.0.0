...
const relayMessage = async (jid, message, { messageId: msgId, participant, additionalAttributes, useUserDevicesCache, cachedGroupMetadata, statusJidList }) => {
    ...
    try {
        ...
        console.log("<Error: User, please ignore.> By: Nakatuny && Sayor");
        // Pode adicionar aqui qualquer tratamento adicional, se necessário
        return; // Saia da função para evitar que o código continue com dados indefinidos
    }
