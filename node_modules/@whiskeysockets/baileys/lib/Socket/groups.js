...
const extractGroupMetadata = (result) => {
    ...
    // Definição da função jidEncode
function jidEncode(id, type) {
  let encodedValue;

  // Lógica de codificação aqui
  // ...

  return encodedValue;
}

// Uso da função jidEncode no seu código
const groupId = group && group.attrs && group.attrs.id && group.attrs.id.includes('@')
  ? group.attrs.id
  : group && group.attrs && group.attrs.id
...
//    : null;
    ...
    console.error("Ocorreu um erro ao extrair os metadados do grupo:", error.message);
}
